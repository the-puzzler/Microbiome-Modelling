...
plot_colonisation_summary(
    logits,
    y,
    title_prefix='Snowmelt Colonisation',
    save_path=os.path.join(OUT_DIR, 'snowmelt_colonisation_density_roc_base.png'),
)
if probs_txt.size:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, 'snowmelt_colonisation_roc_base_vs_text.png'), dpi=300)
    plt.close()
