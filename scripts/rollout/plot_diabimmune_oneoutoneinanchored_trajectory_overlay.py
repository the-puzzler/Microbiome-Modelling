...
def main():
    ...
    base.TRAJ_STROKE_LINEWIDTH = 3.4
    base.PCA_ARROW_MERGE_BINS = 14
    base.PCA_ARROW_HEADWIDTH = 4.5
    base.PCA_ARROW_HEADLENGTH = 6.0
    base.PCA_ARROW_HEADAXISLENGTH = 5.0
    base.JACCARD_REAL_USE_AGE_COLORS = False
    base.JACCARD_REAL_POINT_COLOR = "#9a9a9a"
    base.JACCARD_REAL_POINT_ALPHA = 0.45
    base.JACCARD_ENDPOINT_COLOR = "black"
    base.JACCARD_ENDPOINT_ALPHA = 0.55
    base.JACCARD_ARROW_COLOR = "black"
    base.JACCARD_ARROW_ALPHA = 0.65
    base.JACCARD_ARROW_WIDTH = 0.0028
    base.JACCARD_ARROW_SCALE = 0.9
    base.JACCARD_ARROW_MERGE_BINS = 14
    base.JACCARD_ARROW_HEADWIDTH = 4.5
